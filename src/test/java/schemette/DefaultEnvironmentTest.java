...
public class DefaultEnvironmentTest {
    ...
    public void addition() {
        ...
        assertThat(number(6), is(function.apply(ImmutableList.of(number(1), number(2), number(3)))));
    }
    ...
    public void subtraction() {
        ...
        assertThat(number(5), is(function.apply(ImmutableList.of(number(10), number(2), number(3)))));
    }
    ...
    public void multiplication() {
        ...
        assertThat(number(60), is(function.apply(ImmutableList.of(number(10), number(2), number(3)))));
    }
    ...
    public void division() {
        ...
        assertThat(number(2), is(function.apply(ImmutableList.of(number(12), number(2), number(3)))));
    }
    ...
    public void equality_equals() {
        ...
        assertThat(bool(true), is(function.apply(ImmutableList.of(number(2), number(2), number(2)))));
    }
    ...
    public void equality_not_equals() {
        ...
        assertThat(bool(false), is(function.apply(ImmutableList.of(number(12), number(2), number(3)))));
    }
